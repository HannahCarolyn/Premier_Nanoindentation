...
% Note not needed for basic array. Surface displacement not relevant so will be set to NaN for all values

for indent_loop = 1:initial_number_of_data
    original_load_displacement(indent_loop).Surface_Displacement = NaN;
end
