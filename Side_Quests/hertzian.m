function [Tipradiusfitting,final_main_popin_data_struct]=hertzian(base_file_directory, mapping_type,final_main_popin_data_struct,naughty_indents_list,red_indents_list,numberofexpectedpopin)
...
%     linearfit=polyval(linearfitcoeffcient,hbefore1popin3over2);
    
%     figure(fig1);
%     plot(hbefore1popin3over2,Pbefore1popin,'x black',hbefore1popin3over2,linearfit,'- red');
%     hold on
%     xlabel("h^(3/2) (m)")
%     ylabel("load (N)")
%     title("Hertizan Fit")
