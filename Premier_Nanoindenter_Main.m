...
base_file_directory = "C:\Users\hanna\OneDrive - Nexus365\Year 4\memorystick back up\premier\week8HT\indentssample1grid2100523\";
...
if hannah_oliver_parr == "yes"
    ...
    [main_data_struct,naughty_indents_list,red_indents_list] = oliverandparrmappingversion(base_file_directory,updated_main_data_struct,epsilon,samplepossionratio,tolerance,cutofdatavalue,cutofunloadingtoplim,cutofunloadingbottomlim,naughty_indents_list,red_indents_list);
        ...
        [main_data_struct,naughty_indents_list,red_indents_list] = oliverandparrarray2(base_file_directory,updated_main_data_struct,epsilon,samplepossionratio,tolerance,cutofdatavalue,cutofunloadingtoplim,cutofunloadingbottomlim,naughty_indents_list,red_indents_list);   
        end
    end
...
%% Hertizan fitting
if popin_fitting == "yes"
  [Tipradiusfitting,final_main_popin_data_struct] = hertzian2(base_file_directory, mapping_type,final_main_popin_data_struct,naughty_indents_list,red_indents_list,numberofexpectedpopin);
    else if popin_fitting == "no"
    end
end
